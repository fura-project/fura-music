...
| Lyrics | musicu PlayLyricInfo | `music.musichallSong.PlayLyricInfo/GetPlayLyricInfo` | `ct=11`, `cv=13020508`; encrypted QRC or line-timed original plus optional translation/romanization | Fixture plus ignored live QRC pass; no Cookie or fabricated identity | Fixture pass; M1 end-to-end Human observation remains pending | Optional single-owner credential | One Track; bounded ciphertext, decompressed text, lines and timed segments; line-only results have no fabricated word timing; XML-shaped QRC tolerates evidenced literal/unknown ampersands inside `LyricContent` while retaining structural XML parsing | Empty/no usable original is `Unavailable`, not auth; explicit rejection STOP; malformed required original/envelope is invalid; malformed optional tracks are omitted without discarding a valid original | Fura source/fixture/live; independent route/parser corroboration plus maintainer content-free failure stage; 2026-09-03 | `PRIMARY`; QRC live-proven, line-timed/optional-isolation/pseudo-XML compatibility paths fixture-proven |
